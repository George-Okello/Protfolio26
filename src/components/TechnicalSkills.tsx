    ...
    >
      <div className="px-6 md:px-12 w-full space-y-12">
        <div className="flex flex-col">
          <span className="text-[11px] uppercase tracking-widest opacity-40 italic mb-2">
          ...
          <p className="opacity-80 font-light max-w-2xl mt-4">
            Comprehensive skill set spanning academic research modeling to
            scalable industry deployment and infrastructure.
          </p>
        </div>
